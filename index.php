...
<body>
            ...
            <?php
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="index.php">Record</a>
                        <a class="dropdown-item" href="index.php?id=userProfile">ประวัติโดยย่อ</a>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> API</h3>
            <li id="left" class="sideber__item<?php if ( 'dashboard' == $id ) {
                                                  echo " active";
                                              }?>">
                <a href="index.php?id=dashboard"><i id="left" class="fas fa-tachometer-alt"></i>Record</a>
            </li>
            <?php if ( 'admin' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
                    ...
                    <a href="index.php?id=addManager"><i id="left" class="fas fa-user-plus"></i></i>เพิ่มผู้จัดการ</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allManager' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allManager"><i id="left" class="fas fa-user"></i>ผู้จัดการทุกคน</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addPharmacist' == $id ) {
                    ...
                    <a href="index.php?id=addPharmacist"><i id="left" class="fas fa-user-plus"></i></i>เพิ่ม
                    เภสัชกร</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allPharmacist' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>เภสัชกรทุกท่าน</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addSalesman' == $id ) {
                    ...
                    <a href="index.php?id=addSalesman"><i id="left" class="fas fa-user-plus"></i>เพิ่มพนักงานขาย</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allSalesman' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allSalesman"><i id="left" class="fas fa-user"></i>พนักงานขายทุกคน</a>
            </li>
        </ul>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
        ...
        <div class="container">
                ...
                <?php if ( 'addManager' == $id ) {?>
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">เพิ่มผู้จัดการคนใหม่</div>
            ...
            <div class="pharmacist">
                ...
                <?php if ( 'addPharmacist' == $id ) {?>
                    <div class="addPharmacist">
                        <div class="main__form">
                            <div class="main__form--title text-center">เพิ่มเภสัชกรคนใหม่</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'editPharmacist' == $action ) {
                    ...
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">อัพเดทเภสัช</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
            ...
            <div class="salesman">
                ...
                <?php if ( 'addSalesman' == $id ) {?>
                    <div class="addSalesman">
                        <div class="main__form">
                            <div class="main__form--title text-center">เพิ่มพนักงานขายใหม่</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'editSalesman' == $action ) {
                    ...
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">อัพเดทพนักงานขาย</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <div class="userProfile">
                    <div class="main__form myProfile">
                        <form action="index.php">
                            <div class="main__form--title myProfile__title text-center">โปรไฟล์ของฉัน</div>
                            <div class="form-row text-center">
                                <div class="col col-12 text-center pb-3">
                                    <img src="assets/img/<?php echo $data['avatar']; ?>" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="col col-12">
                                    <h4><b>ชื่อเต็ม : </b><?php printf( "%s %s", $data['fname'], $data['lname'] );?></h4>
                                </div>
                                <div class="col col-12">
                                    <h4><b>อีเมล : </b><?php printf( "%s", $data['email'] );?></h4>
                                </div>
                                <div class="col col-12">
                                    <h4><b>เบอร์โทรศัพท์ : </b><?php printf( "%s", $data['phone'] );?></h4>
                                </div>
            ...
            <?php if ( 'userProfileEdit' == $id ) {
                ...
                <div class="userProfileEdit">
                    <div class="main__form">
                        <div class="main__form--title text-center">อัปเดตโปรไฟล์ของฉัน</div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col col-12">
                                    <label class="input">
                                        ...
                                        <p>
                                        พิมพ์รหัสผ่านเก่าหากคุณไม่ต้องการเปลี่ยนรหัส</p>
                                        <i id="pwd" class="fas fa-eye right"></i>
                                    </label>
                                </div>
